...
Plans are saved under `frontend/test/specs/`. The seed file for generated tests is
`frontend/test/seed.spec.ts`; name it in every plan item. Tests themselves live in
`frontend/test/e2e/`, driven by `frontend/test/playwright.config.ts`.
